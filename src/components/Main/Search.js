...
const Search = ({setTotalHeight, totalHeight, RecentlyViewed}) => {
    ...
    <>
        <div class={`h-80 mb-20 md:relative xl:mx-0 px-0 md:px-6 lg:px-0 ${ revealBool ? "" : "relative"}`}>
            ...
            <div ref={divRef}>
                ...
                <form  class={`bg-white md:top-[132px] inset-0 md:w-[80%] mx-auto flex flex-col drop-shadow-2xl absolute md:h-fit ${ revealBool ? "rounded-md z-50 h-full w-full top-0" : "rounded-full top-[132px] w-[80%] h-fit"}`}>
                    <div ref={searchRef} onClick={(e) => {if(e.target !== e.currentTarget && revealBool===true) return; setRevealBool(true)}}  class="flex flex-row items-center pl-6 h-14">
                        ...
                        <input
                            ...
                            class={`mx-6 text-start justify-center focus:outline-none w-full h-16 form-input bg-transparent cursor-text ${revealBool ? "pl-6" : "pl-0" } md:pl-0`}
                            type="text" 
                            value={search}
                    ...
                    {RecentlyViewed.map(item => 
                       ...
                       <div class="h-[72px] py-4 px-6 bg-white w-full flex flex-row items-center gap-2 hover:bg-gray-100 transition duration-200 ease-in-out hover:cursor-pointer">
                            ...
                            {item.border && <div class="bg-slate-200 pb-[1px] mx-6"></div>}
                            </>
                                    )}
                    </div>
                </form>
