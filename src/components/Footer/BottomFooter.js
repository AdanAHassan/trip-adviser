    ...
    <div class="flex flex-col p-6">
        <div class="flex flex-row gap-4 pb-2">
            ...
            <div class="flex flex-col text-start gap-0.5">
                ...
                <div class="flex flex-row text-sm font-medium gap-4 underline decoration-1 underline-offset-2">
                    <div class="hover:opacity-70">Terms of Use</div>
                    <div class="hover:opacity-70"><a href="https://tripadvdisor.mediaroom.com/uk-privacy-policy">Privacy and Cookies Statement</a></div>
                    <div class="hover:opacity-70">Cookie consent</div>
                    <div class="hover:opacity-70"><a href="https://www.tripadvisor.co.uk/SiteIndex">Site Map</a></div>
                    <div class="hover:opacity-70"><a href="https://www.tripadvisor.co.uk/pages/service_en_UK.html">How the site works</a></div>
                    <div class="hover:opacity-70"><a href="https://tripadvisor.mediaroom.com/UK-contact-us">Contact us</a></div>
                </div>
            </div>
        </div>
